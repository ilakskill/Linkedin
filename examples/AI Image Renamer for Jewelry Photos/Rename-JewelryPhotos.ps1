// @name         Rename-JewelryPhotos
// @namespace    https://github.com/ilakskill/Linkedin
// @version      1.0.0
// @description  Classify jewelry photos using Gemini and rename files + write metadata
// @author       ilakskill
